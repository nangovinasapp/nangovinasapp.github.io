...
style.textContent = `
  ...
  .flutter-loading-bar::before {
    content: '';
    position: absolute;
    inset: 0;
    width: 40%;
    border-radius: inherit;
    background: linear-gradient(90deg, #51d0ff 0%, #7cf6c0 100%);
    animation: flutter-loading-slide 1.1s ease-in-out infinite;
  }

  @keyframes flutter-loading-slide {
    0% {
...
loading.className = 'flutter-loading-overlay';
loading.innerHTML = `
  <div class="flutter-loading-title">Loading</div>
  <div class="flutter-loading-bar" aria-hidden="true"></div>
`;
