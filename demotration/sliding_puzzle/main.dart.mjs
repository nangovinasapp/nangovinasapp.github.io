...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1275: (x0,x1) => x0.getItem(x1),
      _1277: (x0,x1,x2) => x0.setItem(x1,x2),
      _1278: Date.now,
      _1280: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1281: s => {
      ...
      _1283: () => typeof dartUseDateNowForTicks !== "undefined",
      _1284: () => 1000 * performance.now(),
      _1285: () => Date.now(),
      _1286: () => {
      ...
      _1288: () => new WeakMap(),
      _1289: (map, o) => map.get(o),
      _1290: (map, o, v) => map.set(o, v),
      _1291: x0 => new WeakRef(x0),
      _1292: x0 => x0.deref(),
      _1298: () => globalThis.WeakRef,
      _1303: s => JSON.stringify(s),
      _1304: s => printToConsole(s),
      _1305: (o, p, r) => o.replaceAll(p, () => r),
      _1306: (o, p, r) => o.replace(p, () => r),
      _1307: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1308: s => s.toUpperCase(),
      _1309: s => s.trim(),
      _1310: s => s.trimLeft(),
      _1311: s => s.trimRight(),
      _1312: (string, times) => string.repeat(times),
      _1313: Function.prototype.call.bind(String.prototype.indexOf),
      _1314: (s, p, i) => s.lastIndexOf(p, i),
      _1315: (string, token) => string.split(token),
      _1316: Object.is,
      _1321: a => a.pop(),
      _1322: (a, i) => a.splice(i, 1),
      _1323: (a, s) => a.join(s),
      _1324: (a, s, e) => a.slice(s, e),
      _1326: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1327: a => a.length,
      _1329: (a, i) => a[i],
      _1330: (a, i, v) => a[i] = v,
      _1332: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1333: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1334: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1335: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1336: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1337: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1338: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1339: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1341: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1342: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1343: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1344: (t, s) => t.set(s),
      _1346: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1348: o => o.buffer,
      _1349: o => o.byteOffset,
      _1350: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1351: (b, o) => new DataView(b, o),
      _1352: (b, o, l) => new DataView(b, o, l),
      _1353: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1354: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1355: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1356: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1357: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1358: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1359: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1360: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1361: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1362: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1363: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1364: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1367: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1368: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1369: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1370: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1371: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1372: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _1389: o => Object.keys(o),
      _1390: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1391: (handle) => clearTimeout(handle),
      _1394: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1396: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1397: (x0,x1) => globalThis.fetch(x0,x1),
      _1398: (x0,x1) => x0.get(x1),
      _1399: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1399(f,arguments.length,x0,x1,x2) }),
      _1400: (x0,x1) => x0.forEach(x1),
      _1401: x0 => x0.abort(),
      _1402: () => new AbortController(),
      _1403: x0 => x0.getReader(),
      _1404: x0 => x0.read(),
      _1405: x0 => x0.cancel(),
      _1424: (x0,x1) => x0.key(x1),
      _1435: (s, m) => {
        try {
      ...
      _1436: (x0,x1) => x0.exec(x1),
      _1437: (x0,x1) => x0.test(x1),
      _1438: x0 => x0.pop(),
      _1440: o => o === undefined,
      _1442: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1444: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1445: o => o instanceof RegExp,
      _1446: (l, r) => l === r,
      _1447: o => o,
      _1448: o => o,
      _1449: o => o,
      ...
      _1451: o => o.length,
      _1453: (o, i) => o[i],
      _1454: f => f.dartFunction,
      _1455: () => ({}),
      _1456: () => [],
      _1458: () => globalThis,
      _1459: (constructor, args) => {
      ...
      _1461: (o, p) => o[p],
      _1462: (o, p, v) => o[p] = v,
      _1463: (o, m, a) => o[m].apply(o, a),
      _1465: o => String(o),
      _1466: (p, s, f) => p.then(s, f),
      _1467: o => {
      ...
      _1468: o => [o],
      _1469: (o0, o1) => [o0, o1],
      _1470: (o0, o1, o2) => [o0, o1, o2],
      _1471: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1486: x0 => x0.groups,
      _1487: x0 => x0.flags,
      _1488: x0 => x0.multiline,
      _1489: x0 => x0.ignoreCase,
      _1490: x0 => x0.unicode,
      _1491: x0 => x0.dotAll,
      _1492: (x0,x1) => x0.lastIndex = x1,
      _1493: (o, p) => p in o,
      _1494: (o, p) => o[p],
      _1497: x0 => x0.random(),
      _1500: () => globalThis.Math,
      _1501: Function.prototype.call.bind(Number.prototype.toString),
      _1502: Function.prototype.call.bind(BigInt.prototype.toString),
      _1503: Function.prototype.call.bind(Number.prototype.toString),
      _1504: (d, digits) => d.toFixed(digits),
      _1508: () => globalThis.document,
      _1528: x0 => x0.src,
      _1529: (x0,x1) => x0.src = x1,
      _1530: x0 => x0.naturalWidth,
      _1531: x0 => x0.naturalHeight,
      _1547: x0 => x0.status,
      _1548: (x0,x1) => x0.responseType = x1,
      _1550: x0 => x0.response,
      _3387: () => globalThis.window,
      _3714: x0 => x0.localStorage,
      _4047: x0 => x0.length,
      _5992: x0 => x0.signal,
      _7832: x0 => x0.value,
      _7834: x0 => x0.done,
...
"<<EMPTY>>",
"[ServiceManager] error: the service ",
" is not existed, do you forgot to register it?",
"level",
"flutter.",
...
"_prefs",
"SavedKeyForRepo.",
"https://raw.githubusercontent.com/nangovinasapp/resource_sliding_puzzle/refs/heads/main/data_puzzle.json",
"?timestamp=",
...
"Shuffle board",
"italic",
"Tip: Hold the magic wand to preview the completed puzzle image.",
"tip",
"<'",
"'>",
"BlurStyle.",
...
"loading",
"Processing image...",
"Please wait while we split your image.",
"_CardVariant.",
"material",
...
"renderView",
"pipelineOwner",
"[PersistentData] initial completed, now you can save the data",
"getAll",
"GA==",
"GQ==",
"flutter/backgesture",
